        ...
        <div class="container box">
            ...
            ?>
                        ...
                        <div class="alert alert-success" id="success">
                            Sucessfully added <strong> <?php echo $prefix." ".$first_name." ".$last_name." ".$suffix; ?></strong>
                            to <strong> <?php echo $pc_name; ?> </strong>
                        </div>
            <?php
                        } else {
            ...
            ?>
                ...
                <?php }elseif($login == 'user'){ ?>
                    <div class="center_button"> <button type="submit" class="btn btn-primary" onclick="window.location.href='../index_php_files/user.php'">Return</button> </div>
                <?php } ?>
            </div>
        </div>
        <script>
